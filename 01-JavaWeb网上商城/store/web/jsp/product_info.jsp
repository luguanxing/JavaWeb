				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">商城价: <strong
								style="color:#ef0101;">￥：${product.shop_price}元</strong> 市场价：
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<form id="myform" action="${pageContext.request.contextPath}/cart?" method="get">
								<%--提交的方法--%>
								...
								<div style="border-bottom: 1px solid #faeac7;margin-top:20px;padding-left: 10px;">购买数量:
									<input id="count" name="count" value="1" maxlength="4" size="10" type="number">
								</div>
