		...
		<div class="container" style="width:100%;background:url('${pageContext.request.contextPath}/image/regist_bg.jpg');">
			<div class="row">
				...
				<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
					<font>会员注册</font><span style='color:red'> ${msg } </span>
					<form class="form-horizontal" style="margin-top:5px;" method="post" action="${pageContext.request.contextPath }/user">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="telephone" placeholder="请输入联系电话" name="telephone">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="usercaption" class="col-sm-2 control-label">姓名<span style="color: red">(*)</span></label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="inputCaptcha" name="inputCaptcha" class="form-control">
