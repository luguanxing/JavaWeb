						...
						<script type="text/javascript">
							...
							d.add('01', -1, '系统菜单树');
								d.add('0102', '01', '分类管理', '', '', 'mainFrame');
									...
									d.add('010202', '0102', '分类添加', '${pageContext.request.contextPath}/adminCategory?method=addCategoryUI', '', 'mainFrame');
								d.add('0104', '01', '商品管理');
									d.add('010401', '0104', '商品列表', '${pageContext.request.contextPath}/adminProduct?method=findAll', '', 'mainFrame');
									d.add('010402', '0104', '商品添加', '${pageContext.request.contextPath}/adminProduct?method=addProductUI', '', 'mainFrame');
								<%--d.add('0105', '01', '订单管理');--%>
