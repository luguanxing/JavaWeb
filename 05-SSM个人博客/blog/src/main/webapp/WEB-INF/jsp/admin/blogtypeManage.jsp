	...
	<head>
		...
		<script type="text/javascript">
			...
			function openBlogtypeModifyDialog(){
				...
				$("#fm").form("load",row);
				url="${pageContext.request.contextPath}/admin/blogtype/update.do?id="+row.id;
			}
					...
					if(r){
						$.post("${pageContext.request.contextPath}/admin/blogtype/delete.do",{ids:ids},function(result){
							if(result.success){
								...
								$.messager.alert("系统提示","数据删除失败！请先删除所有该类别的博客！");
							}
						},"json");
					}
				});
		...
		url="${pageContext.request.contextPath}/admin/blogtype/list.do" fit="true" toolbar="#tb">
			<thead>
				<tr>
					...
					<th field="typeName" width="50" align="center">博客类型名称</th>
					<th field="orderNo" width="30" align="center">排列序号</th>
				</tr>
			</thead>
		</table>
		<div id="tb">
