	...
	<HEAD>
		...
		<script type="text/javascript">
			function addProjectUI() {
				window.location.href = "${pageContext.request.contextPath}/admin?method=addProjectUI";
			}
		</script>
	</HEAD>
	<body>
			...
			<TBODY>
				...
				<tr>
					<td class="ta_01" align="right">
						<button type="button" id="add" name="add" value="添加" class="button_add" onclick="addProjectUI()">
							&#28155;&#21152;
						</button>
					</td>
				</tr>
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 100%; WORD-BREAK: break-all; BORDER-BOTTOM: gray 1px solid; BORDER-COLLAPSE: collapse; BACKGROUND-COLOR: #f5fafe; WORD-WRAP: break-word">
							...
							<c:forEach items="${pagebean.data}" var="project">
								<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="25%">
											<c:out value="${project.click}"/>
									</td>
									<td align="center" style="HEIGHT: 22px">
										<a href="${ pageContext.request.contextPath }/admin?method=editProjectUI&pid=${project.pid}">
											<img src="${pageContext.request.contextPath}/admin/images/i_edit.gif" width="16" height="16" border="0" style="CURSOR: hand">
										</a>
									</td>
									<td align="center" style="HEIGHT: 22px">
										<a href="${ pageContext.request.contextPath }/admin?method=deleteProject&pid=${project.pid}">
				...
				<tr align="center">
					<td colspan="4">
						...
						<c:if test="${pagebean.pageNumber != 1}">
							<a href="${ pageContext.request.contextPath }/admin?method=listProject">首页</a>|
							<a href="${ pageContext.request.contextPath}/admin?method=listProject&pageNumber=${pagebean.pageNumber-1}">上一页</a>
						</c:if>
						<c:if test="${pagebean.pageNumber != pagebean.totalPage}">
							<a href="${ pageContext.request.contextPath }/admin?method=listProject&pageNumber=${pagebean.pageNumber+1}">下一页</a>
							<a href="${ pageContext.request.contextPath }/admin?method=listProject&pageNumber=${pagebean.totalPage}">尾页</a>
						</c:if>
					</td>
				</tr>
			</TBODY>
