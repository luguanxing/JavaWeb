...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="${pageContext.request.contextPath}/main/js/jquery.min.js" type="text/javascript"></script>
		<style type="text/css">
			body {
				color: white;
			}
	...
	<body style="background: #278296">
		...
		<form method="post" action="${pageContext.request.contextPath }/login?method=adminLogin" name='theForm' onsubmit="return validate()">
