							...
							<c:forEach items="${pagebean.data}" var="comment">
								<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
									...
									<td align="center" style="HEIGHT: 22px">
										<a href="${ pageContext.request.contextPath }/admin?method=deleteComment&cid=${comment.cid}">
				...
				<tr align="center">
					<td colspan="4">
						...
						<c:if test="${pagebean.pageNumber != 1}">
							<a href="${ pageContext.request.contextPath }/admin?method=listComment">首页</a>|
							<a href="${ pageContext.request.contextPath}/admin?method=listComment&pageNumber=${pagebean.pageNumber-1}">上一页</a>
						</c:if>
						<c:if test="${pagebean.pageNumber != pagebean.totalPage}">
							<a href="${ pageContext.request.contextPath }/admin?method=listComment&pageNumber=${pagebean.pageNumber+1}">下一页</a>
							<a href="${ pageContext.request.contextPath }/admin?method=listComment&pageNumber=${pagebean.totalPage}">尾页</a>
						</c:if>
					</td>
				</tr>
			</TBODY>
