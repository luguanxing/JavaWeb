...
<html>
	<head>
		...
		*{padding: 0px;margin: 0px;}
		...
		.c_logo{
			background: url("${pageContext.request.contextPath}/static/images/about_icon.png") no-repeat;
			padding: 10px 10px;
			position: absolute;
			top: 12px;
			left: 40px;
	...
	<body>
		...
		<form action="${pageContext.request.contextPath}/adminer/login.do" method="post" onsubmit="return checkForm()">
			<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 240px; text-align: center;">
				...
				<P style="padding: 30px 0px 10px; position: relative;">
					...
					<INPUT id="username" name="username" class="ipt" type="text" placeholder="请输入用户名" value="${adminer.username }"> 
			    </P>
				<P style="position: relative;">
					<SPAN class="p_logo"></SPAN>         
					<INPUT id="password" name="password" class="ipt"  type="password" placeholder="请输入密码" value="${adminer.password }">   
			  	</P>
				<P style="position: relative;">
					<img type="button" onclick="changeCaptcha()" id="captchaImg" style="width:100px; top:11px; position: relative; cursor:pointer" src="${pageContext.request.contextPath}/captcha.html" />
					<SPAN style="left:145px; top:20px" class="c_logo"></SPAN>   
					<INPUT style="width:185px;" id="captcha" name="captcha" class="ipt"  type="text" placeholder="请输入验证码">   
			  	</P>    
				<DIV style="margin-top: 20px; height: 50px; line-height: 50px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
			        ...
			        <SPAN style="float: right;"> 
			              <input type="submit" style="margin-top: 12px; background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;" value="登录"/> 
			         </SPAN>         
			         </P>
			    </DIV>
			</DIV>
