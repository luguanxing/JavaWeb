...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function openPasswordModifyDialog(){
				...
				url="${pageContext.request.contextPath}/admin/adminer/modifyPassword.do";
			}
			...
			function importRedis() {
				url="${pageContext.request.contextPath}/admin/importRedis.do";
			    $.ajax({
			    	url:url,
			    	success:function(result) {
			    		var result=eval('('+result+')');
			        	if (result.success) {
			        		$.messager.alert("系统提示","数据导入缓存成功");
			        		$("#dlg2").dialog("close");
			        	} else {
	...
	<body class="easyui-layout">
		...
		<div id="dlg2" class="easyui-dialog" style="width: 345px;height: 150px;padding: 10px 20px" closed="true" buttons="#dlg-buttons2">
			是否将数据导入到索引或缓存?
		</div>
		<div id="dlg-buttons2">
