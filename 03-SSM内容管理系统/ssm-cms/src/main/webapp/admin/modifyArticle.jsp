		...
		<div id="p" class="easyui-panel" title="编写帖子" style="padding: 5px">
			...
			<table cellspacing="10px">
					...
					<tr id="hdtp" style="display: none;">
						<td>幻灯图片：</td>
						<td>
							<img id="img" width="200px" height="100px"/>
					...
					<tr>
						<td>标题颜色：</td>
						<td>
						<input type="text" id=titleColor name="titleColor" value="#000000"/>
			...
			ue.addListener("ready",function(){
				UE.ajax.request("${pageContext.request.contextPath}/admin/article/findById.do",{
					...
					onsuccess:function(result){
						...
						console.log(result);
						$("#img").attr('src', "${pageContext.request.contextPath}/static/userImages/" +result.slideImage); 
