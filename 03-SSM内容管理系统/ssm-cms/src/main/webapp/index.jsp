		...
		<div class="content">
			<div class="w960">
				...
				<div class="right">
		         ...
		         <c:forEach var="subIndexArticleList" items="${subArticleLists }" varStatus="allStatus">
		        	...
		        	<c:forEach var="indexArticle" items="${subIndexArticleList}" varStatus="oneStatus">
		        	    ...
		        	    <li>[<fmt:formatDate value="${indexArticle.publishDate }" pattern="MM-dd" />]&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/article/${indexArticle.id }.html"
